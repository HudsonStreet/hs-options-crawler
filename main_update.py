...
"""
Return: Get a list of option details
Parameters: A list of option codes
"""
def get_multi_op_price(code_list):
    base_url = "http://hq.sinajs.cn/list=CON_OP_{code}".format(code=code)
...
if __name__ == '__main__':
    ...
    # for index, i in enumerate(get_op_price('10001677')):
    #     print('期权10001677', index, *i)
    print("-------------------------------------Get Option Codes----------------------------")
    print(get_op_codes('201904'))
    print("-------------------------------------Option details----------------------------")
    print(get_op_price('10001677'))
    print("--------------------------------------------------------------------------------")
